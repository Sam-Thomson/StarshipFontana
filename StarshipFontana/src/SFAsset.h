 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_PROJECTILE1, SFASSET_ALIEN, SFASSET_ALIEN1, SFASSET_ALIEN2, SFASSET_ALIEN3, SFASSET_COIN, SFASSET_WALL, SFASSET_WALL1, SFASSET_WALL2, SFASSET_KEY, SFASSET_STAR, SFASSET_MESSAGE, SFASSET_MESSAGE1};
